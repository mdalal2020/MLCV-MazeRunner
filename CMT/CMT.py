...
class CMT(object):
	...
	def initialise(self, im_gray0, tl, br):
		...
		(keypoints_cv, self.descriptor) = self.detector.detectAndCompute(im_gray0, None)
		...
		selected_keypoints_cv, self.selected_features = self.detector.compute(im_gray0, selected_keypoints_cv)
		...
		background_keypoints_cv, background_features = self.detector.compute(im_gray0, background_keypoints_cv)
	...
	def process_frame(self, im_gray):
		...
		keypoints_cv, features = self.detector.compute(im_gray, keypoints_cv)
